...
## Abstract
Solar eclipses offer natural experiments to evaluate the effect of light on animal behavior. Nearly a century ago, PNAS published a study that used volunteer observations to describe organismal responses to a total solar eclipse in 1932, providing a multi-taxa foundation that promised to inform future studies. Building on this work, and enabled by advances in automated data collection, we analyzed data for 181 bird species from 873 locations sampled by the Eclipse Soundscapes Project and BirdWeather, two participatory science programs in which volunteers deploy acoustic recording units, to quantify avian behavioral responses to the 2023 annular eclipse and 2024 total eclipse in North America. Our foci were to understand drivers of variability in avian responses to eclipses and quantify the levels of solar obscuration that either promote or suppress vocal activity. Most species were less likely to vocalize during the maximum of the total eclipse but showed no changes in vocalization during the maximum of the annular eclipse. Diel niche and eye size were the traits most strongly linked to eclipse responses, with nocturnal and large-eyed species being especially likely to vocalize during the maximum of the total eclipse. During the total eclipse, locations with 70–93% solar obscuration experienced increases in bird vocalization during totality; locations with >94% solar obscuration (which occurred within 285 km of the eclipse path centerline) experienced decreases in vocalization. Our results provide a quantitative synthesis of avian responses to eclipses and demonstrate the power of the people in documenting biological responses to ephemeral conditions.
