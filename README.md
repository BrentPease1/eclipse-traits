...
## Abstract
Solar eclipses offer natural experiments to evaluate the effect of light fluctuations on wildlife behavior. Nearly a century ago, PNAS published a study that used volunteer observations to qualitatively describe animal responses to a total solar eclipse in 1932, noting increased activity among nocturnal species during totality. Building on this foundation, and enabled by recent advances in automated data collection, we analyzed data for 181 bird species from 873 locations sampled by the Eclipse Soundscapes Project and BirdWeather, two participatory science programs in which volunteers deploy acoustic recording units, to quantify avian behavioral responses to the 2023 annular eclipse and 2024 total eclipse in North America. Our foci were to 1) understand drivers of variability in avian behavioral responses to eclipses and 2) quantify the levels of solar obscuration that either promote or suppress vocal activity. On average, most species were less likely to vocalize during totality but showed no changes in vocalization during annularity. The diel niche of a species strongly predicted its response to the total eclipse: species that typically vocalize before sunrise and after sunset were especially likely to vocalize during totality. Similarly, eye size predicted eclipse response, with large-eyed species more likely to vocalize during totality than small-eyed species. During the total eclipse, with 70-93% solar obscuration, bird vocalization increased during totality, whereas suppressive vocalization behavior emerged at 94% solar obscuration, which corresponded to approximately 285 km from the path of totality.  Our results provide a quantitative synthesis of avian responses to eclipses and demonstrate the power of the people in documenting biological responses to ephemeral light fluctuations. 
